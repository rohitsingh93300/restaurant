  ...
  return (
    <div className='px-4 lg:px-0 py-10 bg-white'>
      <div className='text-center'>
        ...
        <p className='text-sm lg:text-xl '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum reprehenderit nesciunt at?</p>
        <div
        style={{
            maskImage: 'linear-gradient(to right, hsl(0 0% 0% /0), hsl(0 0% 0% / 1) 10%, hsl(0 0% 0% /1) 90%,hsl(0 0% 0% /0))',
            WebkitMaskImage: 'linear-gradinet(to right, hsl(0 0% 0% / 0), hsl(0 0% 0% / 1) 10%, hsl(0 0% 0% / 1) 9%, hsl(0 0% 0% / 0))',
        }}
